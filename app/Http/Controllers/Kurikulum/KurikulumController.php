...
class KurikulumController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('kurikulum.kurikulum.index', compact('kurikulum', 'search'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kurikulum.kurikulum.index')->with('success', 'Kurikulum berhasil ditambahkan.');
    }
    ...
    public function show($id)
    {
        ...
        return view('kurikulum.kurikulum.show', compact('kurikulum'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('kurikulum.kurikulum.index')->with('success', 'Kurikulum berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($kurikulum->mataPelajarans()->count() > 0) {
            return redirect()->back()->with('error', 'Tidak dapat menghapus kurikulum yang masih memiliki mata pelajaran.');
        }

        $kurikulum->delete();

        return redirect()->route('kurikulum.kurikulum.index')->with('success', 'Kurikulum berhasil dihapus.');
    }
}