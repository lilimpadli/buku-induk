...
<div class="container mt-4">
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Tambah Akun Siswa</h1>
        </div>
    ...
    @if ($errors->any())
        <div class="alert-modern alert-danger-modern">
            ...
            <div class="alert-content-modern">
                <div class="alert-title-modern">Terjadi kesalahan saat mengisi form</div>
    ...
    <div class="card-modern">
        <div class="card-header-modern">
            <h3 class="h4 mb-0">Form Tambah Data Siswa</h3>
        </div>
        <div class="card-body-modern">
            <form method="POST" action="{{ route('tu.siswa.store') }}" id="createForm">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-row-modern">
                        <div>
                            ...
                            <input type="text" name="nama_lengkap" class="form-control-modern" 
                        ...
                        <div>
                            ...
                            <input type="text" name="nis" class="form-control-modern" 
                        ...
                        <div>
                            ...
                            <input type="text" name="nisn" class="form-control-modern" 
                        ...
                        <div>
                            ...
                            <select name="jenis_kelamin" class="form-select-modern" required>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row-modern">
                        <div>
                            ...
                            <select name="jurusan_id" class="form-select-modern" required>
                        ...
                        <div>
                            ...
                            <select id="kelasSelect" class="form-select-modern" required>
                                <option value="">-- Pilih Kelas --</option>
                                @foreach(($allKelas ?? collect()) as $k)
                        ...
                        <div>
                            <label class="form-label-modern">
                                Rombel <span class="required">*</span>
                            </label>
                            <select id="rombelSelect" class="form-select-modern" required>
                                <option value="">-- Pilih Rombel --</option>
                                @foreach(($allRombels ?? collect()) as $r)
                                    <option value="{{ $r->id }}" data-kelas="{{ $r->kelas_id }}">
                                        {{ $r->nama }}
                                    </option>
                                @endforeach
                            </select>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (form && submitBtn) {
        form.addEventListener('submit', function(e) {
            ...
            submitBtn.innerHTML = '<span class="spinner-modern"></span> Membuat Akun...';
        });
    }
