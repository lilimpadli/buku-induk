...
<div class="container-fluid px-3 px-md-4 mt-3 mt-md-4">
    <div class="card ppdb-sesi-card">
        <div class="ppdb-sesi-header">
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="empty-state">
                                        ...
                                        <p class="mb-0">Belum ada pendaftar untuk jurusan dan sesi ini</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
