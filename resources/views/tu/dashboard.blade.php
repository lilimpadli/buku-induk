...
{{-- STATISTIK --}}
<div class="stats-grid d-grid gap-3 gap-md-4 mb-4 fade-in-1">
    ...
    <div class="stat-card stat-primary">
        ...
        <h2 class="stat-value">{{ $totalSiswa }}</h2>
    </div>
    ...
    <div class="stat-card stat-success">
        <div class="stat-card-header">
            ...
            <div>
                <p class="stat-title">Wali Kelas</p>
                <p class="stat-label">Guru Aktif</p>
            </div>
        </div>
        <h2 class="stat-value">{{ $totalWaliKelas }}</h2>
    </div>
    ...
    <div class="stat-card stat-info">
        ...
        <h2 class="stat-value">{{ $totalKelas }}</h2>
    </div>
    ...
    <div class="stat-card stat-warning">
        <div class="stat-card-header">
            ...
            <div>
                <p class="stat-title">Nilai Terinput</p>
                <p class="stat-label">Total Entri</p>
            </div>
        </div>
        <h2 class="stat-value">{{ $totalNilai }}</h2>
    </div>

</div>

{{-- ROW 1: Siswa Terbaru + Nilai Raport --}}
<div class="row g-3 g-md-4 mb-3 mb-md-4">

    {{-- SISWA TERBARU --}}
    <div class="col-12 col-xl-6">
        <div class="section-card fade-in-2 h-100">
            <div class="section-card-header">
                <h5>Siswa Terbaru</h5>
                <a href="{{ route('tu.siswa.index') }}" class="btn-see-all">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('tu.siswa.detail', $siswa->id) }}" class="btn-detail" title="Lihat Detail">
            ...
            <div class="d-md-none">
                ...
                <div class="mobile-item">
                    <div class="mobile-top">
                        ...
                        <a href="{{ route('tu.siswa.detail', $siswa->id) }}" class="btn-detail flex-shrink-0">
                            <i class="fas fa-eye"></i>
                        </a>
                    </div>
    ...
    <div class="col-12 col-xl-6">
        <div class="section-card fade-in-2 h-100">
            <div class="section-card-header">
                <h5>Nilai Raport Terbaru</h5>
                <a href="{{ route('tu.laporan.nilai') }}" class="btn-see-all">
                    <i class="fas fa-list me-1"></i>Lihat Semua
                </a>
            </div>
            ...
            <div class="table-responsive d-none d-md-block">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="fw-medium">{{ $nilai->siswa->nama_lengkap }}</td>
                            <td class="text-muted">{{ $nilai->mata_pelajaran }}</td>
                            <td class="text-center">
                                <span class="badge-value">{{ $nilai->nilai_pengetahuan }}</span>
                            </td>
                            <td class="text-center">
                                <a href="{{ route('tu.siswa.detail', $nilai->siswa->id) }}" class="btn-detail" title="Lihat Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                            </td>
                        </tr>
            ...
            <div class="d-md-none">
                ...
                <div class="mobile-item">
                    <div class="mobile-top">
                        <div class="mobile-name">{{ $nilai->siswa->nama_lengkap }}</div>
                        <span class="badge-value flex-shrink-0">{{ $nilai->nilai_pengetahuan }}</span>
                    </div>
                    <div class="mobile-meta">
                        <span><span class="meta-label">Mapel</span> {{ $nilai->mata_pelajaran }}</span>
                        <a href="{{ route('tu.siswa.detail', $nilai->siswa->id) }}" class="btn-detail ms-auto" style="width:28px;height:28px;font-size:13px;">
                            <i class="fas fa-eye"></i>
                        </a>
                    </div>
                </div>
...
{{-- ROW 2: Wali Kelas + Ringkasan Kelas --}}
<div class="row g-3 g-md-4">

    {{-- RINGKASAN WALI KELAS --}}
    <div class="col-12 col-xl-6">
        <div class="section-card fade-in-3 h-100">
            <div class="section-card-header">
                <h5>Ringkasan Wali Kelas</h5>
                <a href="{{ route('tu.wali-kelas') }}" class="btn-see-all">
                    <i class="fas fa-list me-1"></i>Lihat Semua
                </a>
            </div>
            ...
            <div class="table-responsive d-none d-md-block">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        @forelse ($waliKelasLimit as $wk)
                        <tr>
                            <td class="fw-medium">{{ $wk->name }}</td>
                            <td class="text-muted">{{ $wk->nomor_induk }}</td>
                            <td class="text-muted d-none d-lg-table-cell" style="max-width:200px;">
                                <div class="text-truncate" title="{{ $wk->email }}">{{ $wk->email }}</div>
                            </td>
                        </tr>
                        @empty
                        <tr>
            ...
            <div class="d-md-none">
                ...
                <div class="mobile-item">
                    <div class="mobile-top">
                        <div class="mobile-name">{{ $wk->name }}</div>
                    </div>
                    <div class="mobile-meta">
                        <span><span class="meta-label">NIP</span> {{ $wk->nomor_induk }}</span>
                        <span class="text-truncate" style="max-width:180px;" title="{{ $wk->email }}">
                            <span class="meta-label">Email</span> {{ $wk->email }}
                        </span>
                    </div>
                </div>
                @empty
    ...
    <div class="col-12 col-xl-6">
        <div class="section-card fade-in-3 h-100">
            <div class="section-card-header">
                <h5>Ringkasan Kelas</h5>
                <a href="{{ route('tu.kelas.index') }}" class="btn-see-all">
                    <i class="fas fa-list me-1"></i>Lihat Semua
                </a>
            </div>
            ...
            <div class="table-responsive d-none d-md-block">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        @forelse ($kelasLimit as $k)
                        <tr>
                            <td class="fw-medium">{{ $k->tingkat }}</td>
                            <td class="text-muted">{{ $k->jurusan->nama }}</td>
                        </tr>
                        @empty
                        <tr>
            ...
            <div class="d-md-none">
                ...
                <div class="mobile-item">
                    <div class="mobile-top">
                        <div class="mobile-name">{{ $k->tingkat }}</div>
                    </div>
                    <div class="mobile-meta">
                        <span><span class="meta-label">Jurusan</span> {{ $k->jurusan->nama }}</span>
                    </div>
                </div>
                @empty
                <div class="mobile-empty">
