        ...
        <div class="card mb-3">
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('kaprog.raport.siswa') }}?siswa_id={{ $siswa->id }}"
                        class="btn btn-primary btn-sm">Lihat Raport</a>
                    <a href="{{ route('kaprog.siswa.export-data-diri', $siswa->id) }}" class="btn btn-success btn-sm"
                        target="_blank">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        @if($siswa->foto)
                            <img src="/storage/{{ $siswa->foto }}" class="img-fluid rounded-circle mb-3" alt="Foto Siswa"
                        ...
                        <ul class="nav nav-tabs" id="infoTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="personal-tab" data-bs-toggle="tab" href="#personal"
                                    role="tab" aria-controls="personal" aria-selected="true">Data Pribadi</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="academic-tab" data-bs-toggle="tab" href="#academic" role="tab"
                                    aria-controls="academic" aria-selected="false">Data Akademik</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade" id="academic" role="tabpanel" aria-labelledby="academic-tab">
                                <ul class="info-list">
                                    ...
                                    <li>
                                        ...
                                        <span class="value">{{ optional($siswa->rombel->kelas)->tingkat ?? '-' }} -
                                            {{ optional($siswa->rombel->kelas->jurusan)->nama ?? '-' }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="card mt-3">
            <div class="card-body">
                <ul class="nav nav-tabs" id="familyTabs" role="tablist">
                    @if($siswa->ayah)
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="father-tab" data-bs-toggle="tab" href="#father" role="tab"
                                aria-controls="father" aria-selected="true">Data Ayah</a>
                        </li>
                    @endif
                    @if($siswa->ibu)
                        <li class="nav-item {{ !$siswa->ayah ? 'active' : '' }}" role="presentation">
                            <a class="nav-link {{ !$siswa->ayah ? 'active' : '' }}" id="mother-tab" data-bs-toggle="tab"
                                href="#mother" role="tab" aria-controls="mother"
                                aria-selected="{{ !$siswa->ayah ? 'true' : 'false' }}">Data Ibu</a>
                        </li>
                    @endif
                    @if($siswa->wali)
                        <li class="nav-item {{ !$siswa->ayah && !$siswa->ibu ? 'active' : '' }}" role="presentation">
                            <a class="nav-link {{ !$siswa->ayah && !$siswa->ibu ? 'active' : '' }}" id="guardian-tab"
                                data-bs-toggle="tab" href="#guardian" role="tab" aria-controls="guardian"
                                aria-selected="{{ !$siswa->ayah && !$siswa->ibu ? 'true' : 'false' }}">Data Wali</a>
                        </li>
                    @endif
                </ul>
                <div class="tab-content" id="familyTabsContent">
                    ...
                    @endif
                    @if($siswa->ibu)
                        <div class="tab-pane fade {{ !$siswa->ayah ? 'show active' : '' }}" id="mother" role="tabpanel"
                    ...
                    @endif
                    @if($siswa->wali)
                        <div class="tab-pane fade {{ !$siswa->ayah && !$siswa->ibu ? 'show active' : '' }}" id="guardian"
