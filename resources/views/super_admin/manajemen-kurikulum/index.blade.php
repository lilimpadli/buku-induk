...
<div class="container-fluid px-3 px-md-4 mt-3 mt-md-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('super_admin.manajemen-kurikulum.create') }}" class="btn btn-primary">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('super_admin.manajemen-kurikulum.index') }}" class="row g-2 align-items-end">
                <div class="col-md-6">
