...
<div class="container-fluid py-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3 mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Tambahkan jurusan baru agar daftar jurusan tetap akurat dan mudah diakses.</p>
        </div>
    ...
    <div class="card dashboard-panel border-0 overflow-hidden">
        <div class="card-header py-4 px-4">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                <div>
                    <h3 class="mb-1">Form Jurusan</h3>
                    <p class="text-muted mb-0">Isi detail jurusan untuk memastikan data dapat dicari dan dilaporkan dengan benar.</p>
                </div>
                <div class="text-muted small">Field wajib diisi untuk menyimpan.</div>
            </div>
        </div>
        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('kurikulum.jurusan.store') }}" method="POST" class="row g-3">
                @csrf

                <div class="col-12">
                    <label for="kode" class="form-label">Nama Singkat Jurusan</label>
                    <input type="text" class="form-control form-control-modern @error('kode') is-invalid @enderror" id="kode" name="kode" value="{{ old('kode') }}" required>
                    @error('kode')
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control form-control-modern @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama') }}" required>
                    @error('nama')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12">
                    <div class="d-flex flex-column flex-sm-row justify-content-end gap-2 mt-2">
                        ...
                        <button type="submit" class="btn btn-primary btn-primary-modern">Simpan</button>
                    </div>
                </div>
            </form>
        </div>
