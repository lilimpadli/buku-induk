...
<div class="container-fluid">
    ...
    <div class="filter-section">
        <form action="{{ route('super_admin.manajemen-jurusan.index') }}" method="GET" class="search-form">
        ...
        <a href="{{ route('super_admin.manajemen-jurusan.create') }}" class="btn btn-primary">
                        ...
                        <div class="card-actions">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $jurusan->id }}">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('super_admin.manajemen-jurusan.edit', $jurusan->id) }}">
                                    ...
                                    <li>
                                        <form action="{{ route('super_admin.manajemen-jurusan.destroy', $jurusan->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" 
