...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('super_admin.manajemen-guru.index') }}" class="btn btn-secondary">Kembali</a>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="alert alert-light border border-secondary mt-4">
                ...
                <br>
                <a href="{{ route('super_admin.manajemen-guru.import.template') }}" class="btn btn-sm btn-outline-secondary mt-2">
                    <i class="fas fa-download"></i> Download Template Excel
                </a>
            </div>

            <form action="{{ route('super_admin.manajemen-guru.import') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                @csrf
                <div class="mb-3">
