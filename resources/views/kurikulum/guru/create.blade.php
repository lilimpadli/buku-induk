...
<div class="container-fluid px-4">
    <div class="page-header">
        <h3><i class="fas fa-user-plus me-2"></i> Tambah Guru</h3>
        <div class="text-muted">Isi form berikut untuk menambahkan data guru baru</div>
    </div>

    <div class="card form-card">
        <div class="card-header">
            <h5><i class="fas fa-pen"></i> Form Tambah Guru</h5>
        </div>
        <div class="card-body">
            @if($errors->any())
                ...
                <div class="row" id="assignmentFields">
                    ...
                    <div class="col-md-4 mb-3" id="kelasDiv">
                        ...
                        <select id="kelasSelect" name="kelas_id" class="form-select">
                            ...
                            @foreach($kelas as $k)
                                <option value="{{ $k->id }}" data-jurusan="{{ $k->jurusan_id }}" {{ old('kelas_id') == $k->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4 mb-3" id="rombelDiv">
                        ...
                        <select id="rombelSelect" name="rombel_id" class="form-select">
                            ...
                            @foreach($rombels as $r)
                                <option value="{{ $r->id }}" data-kelas="{{ $r->kelas_id }}" {{ old('rombel_id') == $r->id ? 'selected' : '' }}>
                                    {{ $r->nama }}
                                </option>
                            @endforeach
                        </select>
