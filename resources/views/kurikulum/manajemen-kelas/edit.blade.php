...
<div class="container-fluid px-4">
    <div class="page-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap">
            <div>
                <h3><i class="fas fa-edit me-2"></i> Edit Rombel</h3>
                <div class="text-muted">Perbarui data rombel</div>
            </div>
            <div>
    ...
    <div class="card form-card">
        <div class="card-header">
            <h5><i class="fas fa-pen"></i> Form Edit Rombel — {{ $rombel->nama }}</h5>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form action="{{ route('kurikulum.kelas.update', $rombel->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nama" class="form-control" value="{{ old('nama', $rombel->nama) }}" placeholder="Contoh: X RPL 1" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="guru_id" class="form-select" required>
                            ...
                            @foreach($gurus as $g)
                                <option value="{{ $g->id }}" {{ $g->id == $rombel->guru_id ? 'selected' : '' }}>
                                    {{ $g->nama }}
                                </option>
                            @endforeach
                        </select>
