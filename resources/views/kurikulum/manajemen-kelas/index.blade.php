...
<div class="container-fluid mt-4">
    ...
    @if($rombels->total() > 0)
        <p class="text-muted mb-3">
            Menampilkan {{ $rombels->firstItem() }}-{{ $rombels->lastItem() }}
    ...
    <div class="card mb-4" style="border: 1px solid #E2E8F0; border-radius: 8px;">
        <div class="card-body" style="background-color: #F8FAFC;">
            <form action="{{ route('kurikulum.kelas.index') }}" method="GET" class="row g-3 align-items-end">
                <!-- Search -->
                <div class="col-md-5">
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="{{ route('kurikulum.kelas.index') }}" class="btn btn-outline-secondary w-100">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <form
                                            action="{{ route('kurikulum.kelas.destroy', $rombel->id) }}"
                                            method="POST"
                                        >
                                            @csrf
                                            @method('DELETE')
