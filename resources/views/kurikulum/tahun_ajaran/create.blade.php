...
<div class="container-fluid px-4">
    <div class="page-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap">
            <div>
                <h3><i class="fas fa-plus-circle me-2"></i> Tambah Tahun Ajaran</h3>
                <div class="text-muted">Tambahkan data tahun ajaran baru</div>
            </div>
    ...
    <div class="card form-card">
        <div class="card-body">
            <form action="{{ route('kurikulum.tahun-ajaran.store') }}" method="POST">
                @csrf
