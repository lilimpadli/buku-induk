...
<div class="container-fluid px-4">
    ...
    <div class="card form-card">
        <div class="card-header">
            <h5><i class="fas fa-pen"></i> Form Edit User</h5>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <div class="info-box">
                ...
                <strong>Role:</strong> {{ $roles[$user->role] ?? $user->role }}
            </div>

            <form action="{{ route('kurikulum.user.update', $user->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nomor_induk" class="form-control @error('nomor_induk') is-invalid @enderror" value="{{ old('nomor_induk', $user->nomor_induk) }}">
                        @error('nomor_induk')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
