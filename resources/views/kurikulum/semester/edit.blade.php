{{-- resources/views/kurikulum/semester/edit.blade.php --}}
@extends('layouts.app')
...
<div class="container-fluid px-4">
    <div class="page-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap">
            <div>
                <h3><i class="fas fa-edit me-2"></i> Edit Semester</h3>
                <div class="text-muted">Perbarui data semester</div>
            </div>
            <div class="mt-2 mt-sm-0">
                <a href="{{ route('kurikulum.semester.index') }}" class="btn-back">
    ...
    <div class="card form-card">
        <div class="card-body">
            ...
            <form action="{{ route('kurikulum.semester.update', $semester->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="is_current" class="form-label">Semester Berjalan</label>
                        <select class="form-select @error('is_current') is-invalid @enderror" id="is_current" name="is_current">
                            <option value="0" {{ old('is_current', $semester->is_current) == '0' ? 'selected' : '' }}>Tidak</option>
                            <option value="1" {{ old('is_current', $semester->is_current) == '1' ? 'selected' : '' }}>Ya</option>
                        </select>
                        @error('is_current')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="text-muted-small">Hanya satu semester yang bisa menjadi semester berjalan</div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('keterangan') is-invalid @enderror"
                              ...
                              name="keterangan"
                              rows="2"
                              placeholder="Masukkan keterangan (opsional)">{{ old('keterangan', $semester->keterangan) }}</textarea>
                    @error('keterangan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-flex gap-2 mt-4">
                    ...
                    <a href="{{ route('kurikulum.semester.index') }}" class="btn-secondary-custom">
