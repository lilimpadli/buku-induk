{{-- resources/views/kurikulum/semester/create.blade.php --}}
@extends('layouts.app')
...
<div class="container-fluid px-4">
    <div class="page-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap">
            <div>
                <h3><i class="fas fa-plus-circle me-2"></i> Tambah Semester</h3>
                <div class="text-muted">Tambahkan data semester baru</div>
            </div>
    ...
    <div class="card form-card">
        <div class="card-body">
            <form action="{{ route('kurikulum.semester.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('is_current') is-invalid @enderror" id="is_current" name="is_current">
                            <option value="0" {{ old('is_current') == '0' ? 'selected' : '' }}>Tidak</option>
                            <option value="1" {{ old('is_current') == '1' ? 'selected' : '' }}>Ya</option>
                        </select>
                        @error('is_current')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
