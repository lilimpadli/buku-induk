...
<div class="container mt-4">
    <h3>Daftar Siswa</h3>
    <p class="text-muted">Pilih siswa untuk melihat raport</p>

    <div class="card shadow">
        @forelse ($siswas as $siswa)
            <div class="list-group list-group-flush">
                <a href="{{ route('kurikulum.rapor.show', $siswa->id) }}"
                   class="list-group-item list-group-item-action d-flex justify-content-between">
                    ...
                    <div class="report-info">
                        ...
                        <div class="report-details">
                            ...
                            <small>NIS: {{ $siswa->nis }} | Kelas: {{ $siswa->rombel->nama ?? '-' }}</small>
                        </div>
                    </div>

                    <span class="badge">Lihat Raport</span>
        ...
        @empty
            <div class="empty-state">
                ...
                <p>Belum ada data siswa tersimpan.</p>
            </div>
        @endforelse
    </div>
</div>
