...
<div class="container-fluid px-4">
    <div class="page-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap">
            <div>
                ...
                <div class="text-muted">Isi form berikut untuk menambahkan siswa baru</div>
            </div>
            <div>
    ...
    <div class="card form-card">
        <div class="card-header">
            <h5><i class="fas fa-pen"></i> Form Tambah Siswa</h5>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form action="{{ route('kurikulum.siswa.store') }}" method="POST">
                @csrf
