...
<div class="container-fluid">
    ...
    <p class="text-muted mb-4">Tambah data siswa baru.</p>

    <!-- FORM -->
    <div class="card shadow-sm border-0" style="border-radius: 15px;">
        <div class="card-body">
            <form action="{{ route('kurikulum.data-siswa.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="user_id" id="user_id" class="form-control" required>
                                ...
                                <option value="{{ $user->id }}" {{ old('user_id') == $user->id ? 'selected' : '' }}>{{ $user->name }} ({{ $user->nomor_induk }})</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tanggal_diterima" id="tanggal_diterima" class="form-control" value="{{ old('tanggal_diterima') }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="rombel_id" id="rombel_id" class="form-control">
                                ...
                                <option value="{{ $rombel->id }}" {{ old('rombel_id') == $rombel->id ? 'selected' : '' }}>{{ $rombel->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
