...
@section('content')
<style>
    /* ===================== STYLE PPDB SEMUA PENDAFTAR - RESPONSIVE ===================== */
    ...
    .registrant-card:nth-child(1) { animation-delay: 0.05s; }
    .registrant-card:nth-child(2) { animation-delay: 0.1s; }
    .registrant-card:nth-child(3) { animation-delay: 0.15s; }
    .registrant-card:nth-child(4) { animation-delay: 0.2s; }
    .registrant-card:nth-child(5) { animation-delay: 0.25s; }
                            ...
                            <tr>
                                <td colspan="8" class="text-center">
                                    <div class="empty-state">
                                        ...
                                        <p>Belum ada pendaftar untuk jurusan ini</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
                    ...
                    <div class="registrant-card">
                        ...
                        <div class="registrant-details">
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">{{ optional($pendaftar->sesi)->tahun_ajaran ?? '-' }}</div>
                            </div>
                            <div class="detail-item">
