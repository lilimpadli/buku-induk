...
<div class="container py-4">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <form method="GET" action="{{ route('kurikulum.alumni.index') }}" class="d-flex gap-2">
                ...
                @if($tahunSearch)
                    <a href="{{ route('kurikulum.alumni.index') }}" class="btn btn-secondary">
                        Reset
                    </a>
                @endif
            </form>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm hover-shadow">
                        ...
                        <div class="card-footer bg-white border-top">
                            @if($card['count'] > 0)
                                <a href="{{ route('kurikulum.alumni.by-jurusan', ['jurusanId' => $card['jurusan_id']]) }}?tahun={{ urlencode($card['tahun']) }}" class="btn btn-sm btn-primary w-100">
