...
@section('title', 'Review Rapor Alumni')

@section('content')
<style>
    /* ===================== STYLE REVIEW RAPOR ALUMNI ===================== */
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3>Review Rapor</h3>
        <div>
            <a href="{{ route('kurikulum.alumni.raport.list', $siswa->id) }}" class="btn btn-outline-secondary">
                <i class="fas fa-arrow-left"></i> Kembali
            </a>
            <a href="{{ route('kurikulum.alumni.raport.cetak', [
                'siswa_id' => $siswa->id,
                'semester' => $semester,
