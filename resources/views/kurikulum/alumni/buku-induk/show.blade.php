...
<div class="container-fluid buku-induk-container">
    <div class="row mb-4">
        ...
        <div class="col-md-4 text-end">
            <a href="{{ route('kurikulum.alumni.show', $siswa->id) }}" class="btn btn-secondary btn-sm">
                <i class="fas fa-arrow-left"></i> Kembali
            </a>
            <a href="{{ route('kurikulum.alumni.buku-induk.cetak', $siswa->id) }}" target="_blank" class="btn btn-primary btn-sm">
