...
<div class="container-fluid px-4">
    <div class="page-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap">
            <div>
                <h3><i class="fas fa-book me-2"></i> Manajemen Kurikulum</h3>
                <div class="text-muted">Kelola data kurikulum yang digunakan di sekolah</div>
            </div>
            <div class="mt-2 mt-sm-0">
                <a href="{{ route('kurikulum.kurikulum.create') }}" class="btn-gradient">
            ...
            <form method="GET" action="{{ route('kurikulum.kurikulum.index') }}" class="row g-2 align-items-end">
                ...
                <div class="col-md-4">
                    <div class="d-flex gap-1">
                        ...
                        <a href="{{ route('kurikulum.kurikulum.index') }}" class="btn-outline-gradient" style="flex:1; justify-content:center; padding:0.3rem 0.8rem; font-size:0.75rem;">
    ...
    <div class="card table-card">
        <div class="card-header">
            ...
            <span class="badge bg-primary">{{ $kurikulum->total() }}</span>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $kurikulum->firstItem() + $key }}</td>
                            <td><span class="fw-semibold">{{ $k->nama_kurikulum }}</span></td>
                            <td class="text-center">
                                <span class="badge-mapel">{{ $k->mata_pelajarans_count }}</span>
                            </td>
                            <td>{{ $k->created_at->format('d/m/Y') }}</td>
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('kurikulum.kurikulum.show', $k->id) }}" class="btn-detail">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('kurikulum.kurikulum.edit', $k->id) }}" class="btn-edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('kurikulum.kurikulum.destroy', $k->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus kurikulum ini?')">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr>
                            <td colspan="5">
                                <div class="empty-state">
                                    ...
                                    <h5 class="fw-bold text-muted">Belum ada data kurikulum</h5>
