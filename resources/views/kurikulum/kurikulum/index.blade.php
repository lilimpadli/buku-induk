...
<div class="container-fluid px-3 px-md-4 mt-3 mt-md-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('kurikulum.kurikulum.create') }}" class="btn btn-primary">
                    ...
                    <tbody>
                        @forelse($kurikulum as $k)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('kurikulum.kurikulum.show', $k->id) }}" class="btn btn-sm btn-info">Detail</a>
                                    <a href="{{ route('kurikulum.kurikulum.edit', $k->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                    <form method="POST" action="{{ route('kurikulum.kurikulum.destroy', $k->id) }}" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus kurikulum ini?')">
                                        @csrf
                                        @method('DELETE')
