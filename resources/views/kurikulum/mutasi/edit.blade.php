...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 mb-0">
                <i class="fas fa-edit text-primary"></i> Edit Data Mutasi Siswa
            </h1>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('kurikulum.mutasi.update', $mutasi) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="siswa_id" id="siswa_id" class="form-select @error('siswa_id') is-invalid @enderror" required>
                            ...
                            @foreach($siswas as $siswa)
                                <option value="{{ $siswa->id }}" {{ $mutasi->siswa_id == $siswa->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required onchange="updateStatusFields()">
                            ...
                            @foreach($statuses as $key => $label)
                                <option value="{{ $key }}" {{ $mutasi->status == $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="tanggal_mutasi" id="tanggal_mutasi" 
                            ...
                            value="{{ $mutasi->tanggal_mutasi->format('Y-m-d') }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="1" 
                            ...
                            placeholder="Catatan tambahan...">{{ $mutasi->keterangan }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="alasan_pindah" id="alasan_pindah" 
                                ...
                                value="{{ $mutasi->alasan_pindah }}" placeholder="Contoh: Pindah ke kota lain">
                            @error('alasan_pindah')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tujuan_pindah" id="tujuan_pindah" 
                                ...
                                value="{{ $mutasi->tujuan_pindah }}" placeholder="Nama sekolah tujuan">
                            @error('tujuan_pindah')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="no_sk_keluar" id="no_sk_keluar" 
                                ...
                                value="{{ $mutasi->no_sk_keluar }}" placeholder="Contoh: 001/SK/2026">
                            @error('no_sk_keluar')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="date" name="tanggal_sk_keluar" id="tanggal_sk_keluar" 
                                ...
                                value="{{ $mutasi->tanggal_sk_keluar ? $mutasi->tanggal_sk_keluar->format('Y-m-d') : '' }}">
