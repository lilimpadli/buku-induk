    ...
    */
    ...
    ->group(function () {
        ...
        */
        ...
        | CETAK RAPOR
        */
        Route::get('/rapor/{siswa_id}/{semester}/{tahun}', 
...
// =============================
Route::get('input-nilai-raport/{siswa_id}/edit', 
    [InputNilaiRaportController::class, 'edit']
)->name('input_nilai_raport.edit');

Route::post('input-nilai-raport/{siswa_id}/update', 
